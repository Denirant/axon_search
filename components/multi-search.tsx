        ...
        <div className="w-full space-y-3">
            <Accordion type="single" collapsible defaultValue="search" className="w-full">
                <AccordionItem value="search" className="border-none">
                    <AccordionTrigger
                        className="py-3 px-4 bg-white dark:bg-neutral-900 rounded-2xl hover:no-underline border border-neutral-200 dark:border-neutral-800 data-[state=open]:rounded-b-none"
                    >
                    ...
                    <AccordionContent className="pt-0 mt-0 border-0 overflow-hidden">
                        <div className="py-3 px-4 bg-white dark:bg-neutral-900 rounded-b-2xl border border-t-0 border-neutral-200 dark:border-neutral-800">
                            {/* Query badges */}
