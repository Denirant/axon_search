  ...
  const LinkPreview = ({ href, title }: { href: string, title?: string }) => {
    ...
    return (
      <div className="flex flex-col bg-white dark:bg-neutral-800 text-xs m-0">
        <div className="flex items-center gap-1 h-6 space-x-1.5 px-3 py-2 text-xs text-neutral-600 dark:text-neutral-300">
          <Image
            src={`https://www.google.com/s2/favicons?domain=${domain}&sz=128`}
            alt=""
            width={12}
            height={12}
            className="rounded-sm w-fit h-fit"
    ...
    return (
      <HoverCard openDelay={10}>
        <HoverCardTrigger asChild>
          <Link
            ...
            className={isCitation
              ? "w-4 h-4 mr-1 tex-center cursor-pointer text-xs text-[#202020] dark:text-neutral-50 py-0.5 px-1.25 m-0! bg-neutral-200 dark:bg-neutral-500 rounded-md no-underline font-medium inline-flex items-center justify-center -translate-y-[1px] leading-none hover:bg-neutral-200/60 dark:hover:bg-neutral-500/60 focus:outline-none focus:ring-1 focus:ring-[#ff8c37] align-baseline"
        ...
        <HoverCardContent
          ...
          align="center"
          sideOffset={5}
          className="w-fit p-0 shadow-md border border-[#1c1c1c]/10 dark:border-neutral-700/80 rounded-xl overflow-hidden bg-neutral-50 dark:bg-neutral-900"
        >
    ...
    table(children) {
      return (
        <div className="w-full my-6 overflow-hidden">
          <div className="w-full overflow-x-auto border border-neutral-200 dark:border-neutral-800 shadow-sm rounded-xl">
