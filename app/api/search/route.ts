...
const scira = customProvider({
    languageModels: {
        ...
        // 'scira-grok-3-mini': xai('grok-2-1212'),
        // 'scira-vision': xai('grok-2-vision-1212'),
        // 'scira-4.1-mini': openai('gpt-4.1-mini', {
        //     structuredOutputs: true,
        // }),
        // 'scira-4.1-nano': openai('gpt-4.1-nano-2025-04-14', {
        //     parallelToolCalls: false,
        //     structuredOutputs: true,
        // }),
                                ...
                                dataStream.writeMessageAnnotation({
                                    ...
                                    data: {
                                        ...
                                        title: step.type === 'web'
                                            ...
                                            : step.type === 'academic'
                                                ? `Изучаю библиотеку знаний для "${step.query.query}"`
                            ...
                            const { object: gapAnalysis } = await generateObject({
                                ...
                                schema: z.object({
                                    limitations: z.array(z.object({
                                        ...
                                        potential_solutions: z.array(z.any())
                                    })),
