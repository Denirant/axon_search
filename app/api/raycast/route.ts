...
const groupSystemPrompts = {
    web: `You are AxonAI for Raycast, a powerful AI web search assistant.
...
export async function POST(req: Request) {
    ...
    const { text, steps } = await generateText({
        ...
        tools: {
            web_search: tool({
                description: 'Search the web for information with multiple queries, max results and search depth. Putting mathematical formulas in square brackets',
                parameters: z.object({
